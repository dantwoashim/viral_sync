...
export default function MerchantScanPage() {
  ...
  function confirm() {
    if (process.env.NODE_ENV === 'production' && process.env.NEXT_PUBLIC_TERMINAL_DEMO !== 'true') {
      setState('error');
      return;
    }
    setState('signing');
    ...
    <PremiumShell className="terminal-page">
      ...
      <section className="terminal-screen">
        <div className="terminal-copy">
          ...
          <div className="demo-banner">Demo terminal UI. Judge-grade settlement proof is generated by the final proof pipeline.</div>
          <h1>{stateCopy[0]}</h1>
          <p>{stateCopy[1]}</p>
