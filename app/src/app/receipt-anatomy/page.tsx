...
import proofArtifact from '../../../public/proofs/devnet-causal-commerce.json';

type ProofManifest = { pdas?: Record<string, string | number | undefined>; hashes?: Record<string, string | undefined> };
const labels = ['merchantConfig', 'growthCampaign', 'terminalDevice', 'visitorAuthority', 'claimPass', 'nullifierRecord', 'causalReceipt', 'settlementRecord', 'rewardEscrow'];

function load(): ProofManifest { return proofArtifact as ProofManifest; }
  ...
  return (
    <PremiumShell>
      ...
      <section className="premium-proof-console">
        ...
        <p className="premium-lede">A POC-1 receipt is a connected proof object: merchant, campaign, terminal, visitor, claim-pass account, nullifier, receipt, settlement, intent hash, and escrow.</p>
        ...
        <PremiumSurface tone="proof" className="premium-system-section">
          <div className="premium-card-title"><span>Receipt printer</span><h2>THAMEL BREW - Verified Conversion Receipt</h2></div>
