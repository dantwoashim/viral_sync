      ...
      <div className="surface-inner">
        ...
        <section className="metric-stack">
          {model.saasTiers.map((tier) => (
            <div className="metric-line" key={tier.tier}><div className="metric-label"><strong>{tier.tier}</strong><span>{tier.includedVisits} included visits.</span></div><div className="metric-value">{tier.recurringNpr}</div></div>
          ))}
        </section>
