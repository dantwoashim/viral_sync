...
describe("year plan audit artifacts", () => {
  it("documents the requested winning-plan status honestly", () => {
    ...
    expect(audit).to.include("phases 1-2");
    expect(audit).to.include("phases 3-4");
    expect(audit).to.include("phases 5-6");
    expect(audit).to.include("phases 7-8");
    expect(audit).to.include("phases 9-10");
    expect(audit).to.include("phases 11-12");
