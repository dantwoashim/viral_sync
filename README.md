...
Merchants create reward tokens, set a commission rate (typically 8-12%), and let the system handle everything else. No recurring fees, no minimum spend. You only pay when results happen.
