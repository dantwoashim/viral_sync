...
const mockMarker = /mock final fixture|mockFinal|mock-final|fixture/i;
...
function scanJsonFile(file: string) {
  ...
  if (file.endsWith('fraud-gauntlet.json')) {
    ...
    cases.forEach((item, index) => {
      ...
      if (!['devnet_transaction_execution', 'localnet_transaction_execution', 'intent_validator_check', 'mock_final_fixture'].includes(String(item.proofSource ?? ''))) {
