# Day 37 - Implement repository/service layer

Repository-side completion note for the implementation plan audit.

Daily goal: Implement repository/service layer.

Shipped/covered: Typed data access with merchant scoping.

Quality bar: Unit tests for scoping.

Evidence of progress: Business logic leaves route handlers.
