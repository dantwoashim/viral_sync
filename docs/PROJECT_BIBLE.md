...
1. B2B SaaS plus campaign fee
   Charge merchants recurring for referral campaigns, analytics, and redemption tools.
...
- small standalone merchants will likely tolerate low recurring pricing only if setup is easy and ROI is obvious,
