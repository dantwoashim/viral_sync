# Day 9 - Implement register_merchant

Repository-side completion note for the implementation plan audit.

Daily goal: Implement register_merchant.

Shipped/covered: Add MerchantConfig account and event.

Quality bar: Success + duplicate + unauthorized tests.

Evidence of progress: Merchant exists on-chain.
